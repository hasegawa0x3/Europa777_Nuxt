import { useSSRContext, defineComponent, mergeProps, getCurrentInstance, h, computed, ref, watch, unref, nextTick } from 'vue';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate } from 'vue/server-renderer';
import { _ as __nuxt_component_0$1 } from './QImg-55911caf.mjs';
import { u as useStore } from '../server.mjs';
import { c as createComponent, h as hSlot, a as hUniqueSlot, t as tran, b as hMergeSlot } from './translation-9652486b.mjs';
import { a as __nuxt_component_3$1, l as listenOpts, v as vmHasRouter, _ as __nuxt_component_0 } from './QBtn-973e1c12.mjs';
import { u as useVirtualScrollProps, a as useVirtualScroll, c as commonVirtPropsList, b as __nuxt_component_8, i as isNumber, d as isDate, _ as __nuxt_component_15, e as __nuxt_component_6, f as isObject } from './QSelect-2dfaad86.mjs';
import { u as useDarkProps, b as useDark } from './Axios-0124dde3.mjs';
import { g as getScrollTarget, u as useCheckboxProps, a as useCheckboxEmits, b as useCheckbox } from './use-checkbox-4a396aff.mjs';
import { _ as __nuxt_component_2$1 } from './QLinearProgress-7723eb23.mjs';
import { i as injectMultipleProps, a as injectProp } from './use-key-composition-a9d6306d.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    active: {
      type: Boolean,
      required: true
      // Fix typo: replace "require" with "required"
    }
  },
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["flex flex-nowrap items-center justify-center w-26 p-2 cursor-pointer rounded-sm", { "bg-slate-400": __props.active }],
        style: { color: "white", backgroundColor: __props.active ? "#0072FF" : "" }
      }, _attrs))}>`);
      _push(ssrRenderComponent(_component_q_img, {
        class: "w-5 h-5 mr-1",
        src: `/imgs/${__props.icon}.png`,
        alt: "icon"
      }, null, _parent));
      _push(`<p class="pl-1 text-base font-medium">${ssrInterpolate(unref(tran)(__props.name, unref(store).state.lang))}</p></div>`);
    };
  }
});
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CategoryBarItem.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: [`rounded-lg w-full sm:grid grid-cols-${(_a = __props.categories) == null ? void 0 : _a.length} items-center justify-start`]
      }, _attrs))}><!--[-->`);
      ssrRenderList(__props.categories, (category) => {
        _push(ssrRenderComponent(_sfc_main$1, mergeProps({
          key: category.icon
        }, category, {
          onClick: () => props.selectCategory(category == null ? void 0 : category.name)
        }), null, _parent));
      });
      _push(`<!--]--></div>`);
    };
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CategoryBar.vue");
      ...
      const item = slots.item !== void 0 ? slots.item : (scope) => {
        ...
        if (hasSelectionMode.value === true) {
          ...
          child.unshift(
            ...
            h(__nuxt_component_6, { dark: isDark.value })
          );
        }
        const data = {
          class: [
...
export { _sfc_main as _, __nuxt_component_1 as a, __nuxt_component_2 as b, __nuxt_component_3 as c };
//# sourceMappingURL=QTd-dca61d2f.mjs.map
